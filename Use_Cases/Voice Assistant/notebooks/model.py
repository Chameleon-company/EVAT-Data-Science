...
PROJECT_ROOT = Path(__file__).resolve().parents[1]   # notebooks -> Voice Assistant
...
# -------------------------
# Optional: make column names consistent (robustness)
# -------------------------
rename_map = {
    "petrol_price_per_l": "petrol_price_per_l",
    "petrol_price_per_litre": "petrol_price_per_l",
    "petrol_price_per_liter": "petrol_price_per_l",
    "electricity_price_per_kwh": "electricity_price_per_kwh",
    "electricity_price_per_kw": "electricity_price_per_kwh",
    "distance": "distance_km",
    "distance_km": "distance_km",
    "ice_eff_l_per_100km": "ice_eff_l_per_100km",
    "ice_efficiency_l_per_100km": "ice_eff_l_per_100km",
    "savings_ice_minus_ev": "savings_ice_minus_ev",
}
...
required_cols = [
    ...
    "ice_eff_l_per_100km",
    "petrol_price_per_l",
    "savings_ice_minus_ev"
]
missing = [c for c in required_cols if c not in df.columns]
if missing:
    raise ValueError(f"dummy_data.csv is missing required columns: {missing}. Found columns: {list(df.columns)}")
...
# Winsorise target to reduce extreme influence
y_raw = df["savings_ice_minus_ev"].copy()
q_low, q_high = y_raw.quantile([0.01, 0.99])
df["savings_ice_minus_ev"] = y_raw.clip(q_low, q_high)
